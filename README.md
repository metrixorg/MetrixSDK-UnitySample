...
۱. ابتدا  کتابخانه‌ متریکس  را  از [این  لینک](https://storage.backtory.com/metricx/sdk-unity/MetrixSDK-v0.4.0.unitypackage) دانلود  کنید  و  در  پروژه  خود import کنید.
